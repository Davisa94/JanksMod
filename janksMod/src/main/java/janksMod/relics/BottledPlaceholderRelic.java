...
import janksMod.patches.relics.BottledPlaceholderField;
import janksMod.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static janksMod.JanksMod.makeRelicOutlinePath;
import static janksMod.JanksMod.makeRelicPath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = JanksMod.makeID("BottledPlaceholderRelic");
